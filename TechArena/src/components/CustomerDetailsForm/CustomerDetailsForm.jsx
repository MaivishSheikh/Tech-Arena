...
//           state: {
//             customerDetails: formData,
//             deviceName: deviceName, // Pass the device name
...
const CustomerDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        // Get current state or fallback to sessionStorage
        const currentState = state || JSON.parse(sessionStorage.getItem("checkoutState"));
